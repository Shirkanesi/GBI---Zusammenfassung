...
\begin{itemize}
    \item Prädukatenlogische Formeln sind komplizierter aufgebaut als aussagenlogische Formeln
...
\begin{itemize}
    ...
    \item Aus diesem Alphabet lassen sich alle Terme ableiten, allerdings auch viel Blödsinn. Die korrekte Syntax sei aber von nun an als bekannt vorausgesetzt.\\
...
\subsection{Wahrheitswerte von prädikatenlogischen Formeln}
